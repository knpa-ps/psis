		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title">
					<strong>{{$node->node_name}} 캡사이신 관리전환 내역 추가</strong>
				</h3>
			</div>
			...
			<div class="panel-body">
				{{ Form::open(array(
						...
						<fieldset>
							...
							<div class="form-group">
								<label for="region" class="control-label col-xs-2">관리전환 대상 지방청</label>
								<div class="col-xs-10">
							...
							<div class="form-group">
								<label for="event" class="control-label col-xs-2">관리전환명</label>
								<div class="col-xs-10">
						...
						<input type="text" class="hidden" name="type" value="cross">
				...
				<div class="col-xs-12">
					<div class="form-group">
						<label for="doc" class="control-label col-xs-2">증빙서류</label>
						<div class="col-xs-4">
...
<script type="text/javascript">
	$("#region").on('change', function(){
		...
		$.ajax({
			url : base_url+'/equips/capsaicin/get_cross_events',
			data: params,
			type : 'post',
