		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title">
					<strong>{{ $mode === "create" ? "수요조사하기" : "수요조사수정" }}</strong>
				</h3>
			</div>
				...
				{{ Form::open(array(
					...
					<fieldset>
						...
						<div class="form-group">
							<label for="survey_date" class="control-label col-xs-1">보급일자</label>
							<div class="col-xs-2">
								<input type="text" class="form-control input-datepicker input-sm" name="survey_date" id="survey_date" value="{{ $survey->survey_date or ''}}">
							</div>
						</div>
